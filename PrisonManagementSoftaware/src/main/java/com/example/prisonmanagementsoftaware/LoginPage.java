...
public class LoginPage {
    ...
    @FXML
    private TextField useridinputs;
    ...
    void buttonclick(ActionEvent event) throws IOException {
        // Get input values
        String username = useridinputs.getText();
        ...
        if (username.equals(SMuserid) && password.equals(PASSWORD)) {
            ...
            // If credentials don't match, just do nothing or reset the fields
            // Optionally, you could clear the fields for a better user experience.
            useridinputs.clear();
            passwordinput.clear();
        }
    }
